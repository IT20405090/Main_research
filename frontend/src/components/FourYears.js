...
function Age4Years() {
  ...
  useEffect(() => {
    // Fetch data for 4 years from the Flask API endpoint
    fetch(`http://localhost:5000/get_milestone?age=4%20years`)
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      >
        <h1>Development Milestones - 4 Years</h1>
