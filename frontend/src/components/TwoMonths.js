...
function Age2Months() {
  ...
  useEffect(() => {
    // Fetch data for 2 months from the Flask API endpoint
    fetch(`http://localhost:5000/get_milestone?age=2%20months`)
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      >
        <h1>Development Milestones - 2 Months</h1>
