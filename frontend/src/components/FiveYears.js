...
function Age5Years() {
  ...
  useEffect(() => {
    // Fetch data for 5 years from the Flask API endpoint
    fetch(`http://localhost:5000/get_milestone?age=5%20years`)
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      >
        <h1>Development Milestones - 5 Years</h1>
