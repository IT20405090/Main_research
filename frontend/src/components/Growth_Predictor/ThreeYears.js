...
function Age3Years() {
  ...
  useEffect(() => {
    // Fetch data for 2 years from the Flask API endpoint
    fetch(`http://localhost:5000/get_milestone?age=3%20years`)
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      >
        <h1>Development Milestones - 3 Years</h1>
