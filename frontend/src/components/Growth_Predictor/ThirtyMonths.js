...
function Age30Months() {
  ...
  useEffect(() => {
    // Fetch data for 30 months from the Flask API endpoint
    fetch(`http://localhost:5000/get_milestone?age=30%20months`)
    ...
    <div style={{ display: 'flex' }}>
      <div
        style={{
          flex: 3,
          padding: '1em',
          textAlign: 'left',background: 'rgba(173, 216, 230, 0.9)', // Set a white background
          color: 'black', // Set text color to black
        }}
      >
        <h1>Development Milestones - 30 Months</h1>
