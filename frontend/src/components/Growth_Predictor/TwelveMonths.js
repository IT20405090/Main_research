...
function Age12Months() {
  ...
  useEffect(() => {
    // Fetch data for 12 months from the Flask API endpoint
    fetch(`http://localhost:5000/get_milestone?age=12%20months`)
